...
var MongoRx = /** @class */ (function () {
    ...
    MongoRx.prototype.init = function (builder) {
    ...
    MongoRx.prototype.getNamespace = function (param, onlyDb) {
    ...
    MongoRx.prototype.getCollection$ = function (dbOrNamespace) {
        var _this = this;
        return rxjs_1.of(this.client).pipe(operators_1.map(function (client) {
            var ns = _this.getNamespace(dbOrNamespace);
            var collection = client.db(ns.db).collection(ns.collection);
            return collection;
        }));
    };
